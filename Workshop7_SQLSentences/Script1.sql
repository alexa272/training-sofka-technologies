...
INSERT INTO product(proId, supplierSupId, proName, proPrice, proQuantity)
VALUES ('60291','2591', 'Rice', 1.500, 2); 
...
INSERT INTO salesInvoice(salNumInvoice, customerCusDocType, customerCusDocNumber, productProId, storeStoId, salDate, salQuantityProduct)
VALUES('895750','TI','105487589','60285','154860','2022-10-21','3');
...
-- -----------------------------------------------------
-- 3. LOGICAL DELETE TABLE SALE - CAMPO 12
-- -----------------------------------------------------
UPDATE salesInvoice
SET productProId = '60283', salDate= '2020-09-09'
WHERE salNumInvoice = '895746';

UPDATE salesInvoice
SET storeStoId = '154868'
WHERE salNumInvoice = '895744'
OR productProId = '60283';

-- -----------------------------------------------------
-- PHYSICAL DELETIONS OF SALES MADE
-- -----------------------------------------------------
DELETE FROM salesInvoice
WHERE salNumInvoice = '895741'
AND productProId = '60283';

DELETE FROM salesInvoice
WHERE salNumInvoice = '895745'
AND salDate = '2022-10-21';
-- -----------------------------------------------------
-- 4. MODIFY THREE PRODUCTS IN YOUR NAME AND SUPPLIER.
-- -----------------------------------------------------
UPDATE product
SET proName = 'Sugar', supplierSupId = '2580'
WHERE proId = '60285';

UPDATE product
SET proName = 'Spaguetti', supplierSupId = '2590'
WHERE proId = '60282';

UPDATE product
SET proName = 'broccoli', supplierSupId = '2583'
WHERE proId = '60284';
